const Contact = () => {
  return (
    <section className="relative flex flex-col md:flex-row items-center justify-between px-6 md:px-20 lg:px-40 py-12 md:py-16 bg-white min-h-[70vh]">
      ...
      <div className="md:block md:w-1/2 h-full absolute top-10 right-0 flex justify-end">
        <img 
